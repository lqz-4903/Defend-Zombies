...
public class TowerObject : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (info.atkType == 1)
        {
                ...
                Time.time - nowTime >= info.offsetTime)
            {
                ...
                GameObject effObj = Instantiate(Resources.Load<GameObject>(info.eff), gunPoint.position, 
                                                Quaternion.AngleAxis(90, gunPoint.transform.right));
                Destroy(effObj, 0.4f);
        ...
        else
        {
            ...
            {
                //开火特效
                GameObject effObj = Instantiate(Resources.Load<GameObject>(info.eff), this.transform.position + this.transform.up * 1.25f, 
